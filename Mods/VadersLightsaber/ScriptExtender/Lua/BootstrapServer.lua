...
_P("Sheath detection enabled");
local prev_sheathed = -1;
local tickHandler = -1;

local function extendLightsaberBlade(weapon, character)
    _P("Lightsaber is not sheathed");
    Ext.Entity.Get(weapon).ServerItem.Item.Template.VisualTemplate = "a23957ec-70ec-49e7-8f98-d5b27b8ee469"
...
local function retractLightsaberBlade(weapon, character)
    ...
    Ext.Entity.Get(weapon).ServerItem.Item.Template.VisualTemplate = "d4a32959-a9ff-4656-b923-406be89087f6"
